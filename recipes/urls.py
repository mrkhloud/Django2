...
urlpatterns = [
    ...
    path('hx/<int:parent_id>/ingredient/<int:id>/', recipe_ingredients_update_hx_view, name='ingredient_hx_recipe'),
    path('hx/<int:parent_id>/ingredient/', recipe_ingredients_update_hx_view, name='ingredient_new_hx_recipe'),
